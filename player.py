...
class Player:
    ...
    def __repr__(self):
        return f"player name:{self.name} player deck:{self.deck}"

    def set_hand(self, deck):
        """This function getting deck of cards and gives for the player random cards according to number of cards
         for the game"""
